...
<body>
  ...
  <main class="wrap">
${approvalLadderHtml}${chronologySpineHtml}${swimlanesHtml}    <section id="about">
...
`}
${placesMapHtml}${catalogueHtml}${tierMapHtml}${branchTimelineHtml}${lineageHtml}${numbersChartHtml}    <section id="figures">
