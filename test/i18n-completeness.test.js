...
const PUBLISHER_BRACKET_OK = new Set([
  // "(EN)" / "(PT)" name the language EDITION of Wikipedia — the parenthetical
  // names which encyclopedia, it does not characterise it.
  'wikipedia-ccr', 'wikipedia-duquesne', 'wikipedia-wordofgod',
  'wikipedia-dougherty', 'wikipedia-shalom', 'wikipedia-sots',
  'wikipedia-seculo21', 'wikipedia-rossi-album', 'wikipedia-peopleofpraise',
  'wikipedia-guerra', 'wikipedia-motherofgod', 'wikipedia-milingo',
  'wikipedia-macnutt', 'wikipedia-scanlan',
  // "(Dicastery for Laity)" names WHICH Holy See office publishes the
  // directory — the parent publisher, not a characterisation of it.
  'laityfamilylife-shalom', 'laityfamilylife-charis',
]);
// <<< ADOPT
